...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.nextButton.setGeometry(QRect(220, 510, 75, 23))
        ...
        self.prevButton.setGeometry(QRect(110, 510, 75, 23))
        ...
        self.steps.setGeometry(QRect(510, 360, 281, 221))
        self.steps.setScaledContents(True)
        self.steps.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        ...
        self.initialMarkingSet.setScaledContents(False)
        self.initialMarkingSet.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignTop)
        self.initialMarkingSet.setWordWrap(True)
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(10, 540, 141, 16))
        self.actual_marking = QLabel(self.centralwidget)
        self.actual_marking.setObjectName(u"actual_marking")
        self.actual_marking.setGeometry(QRect(10, 570, 131, 16))
